...
namespace NHibernate.JetDriver
{
    ...
    /// </summary>
    [Serializable]
    public class JetAnsiTrimEmulationFunction : ISQLFunction, IFunctionGrammar
    {
        ...
        private static readonly ISQLFunction BothSpaceTrim =
            new SQLFunctionTemplate(NHibernateUtil.String, "trim( ?1 )");

        private static readonly ISQLFunction BothSpaceTrimFrom =
            new SQLFunctionTemplate(NHibernateUtil.String, "trim( ?2 )");
        ...
        public SqlString Render(IList args, ISessionFactoryImplementor factory)
        {
            ...
            throw new InvalidOperationException("Jet suport only TRIM spaces");
        }
